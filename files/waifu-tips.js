...
(function (){
	...
	text = '<br><span style="color:#DAA520;">我是神之右大臣的超级可爱小助手。<br> 有什么想学内容的可以看看主人的博客哦。<br>我会在旁边陪着你的。 </span>';
    } else {
        if(document.referrer !== ''){
            ...
            if (window.location.hostname == referrer.hostname) {
                text = '<span style="color:#DAA520;">欢迎阅读 </span><span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』 </span><br> <span style="color:#DAA520;">对于文章有什么疑问或者建议在评论区评论就可以啦。<br> 主人看到一定会回复的~ </span>';
            ...
            text = '<span style="color:#DAA520;">欢迎阅读 </span><span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』 </span><br> <span style="color:#DAA520;">有什么问题可以联系神之右大臣哦 </span> ';
        }
    }
