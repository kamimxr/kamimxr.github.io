...
$(document).on('copy', function (){
    showMessage('你都贺了些什么呀，贺题要记得打printf哦', 5000, true);
});
...
(function (){
	...
	text = '<br><span style="color:#DF6520;">我是神之右大臣的超级可爱小助手。<br> 有什么想学内容的可以看看主人的博客哦。<br>我会在旁边陪着你的。 </span>';
    } else {
        if(document.referrer !== ''){
            ...
            if (window.location.hostname == referrer.hostname) {
                text = '<span style="color:#DF6520;">欢迎阅读 </span><span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』 </span><br> <span style="color:#DF6520;">对于文章有什么疑问或者建议在评论区评论就可以啦。<br> 主人看到一定会回复的~ </span>';
            } else if (domain == 'baidu') {
                text = 'Hello!<br>你知道AK王<strong>G<font color=red>uoqingshuo</font></strong>巨佬吗？';
            } else if (domain == 'so') {
                text = 'Hello!<br><strong>G<font color=red>uoqingshuo</font></strong>实在是太厉害了';
            } else if (domain == 'google') {
                text = 'Hello!<br>你知道<strong>G<font color=red>uoqingshuo</font></strong>今天又AK了吗';
            } else {
                text = 'Hello! 你知道那位<strong>L<font color=red>ishangze</font></strong>又被阿掉了吗？';
            }
        } else {
            text = '<span style="color:#DF6520;">欢迎阅读 </span><span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』 </span><br> <span style="color:#DF6520;">有什么问题可以联系神之右大臣哦 </span> ';
        }
    }
